...
<head>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- Main Content -->
 			<div class="col-md-9 mt-3"  style= "margin-bottom: 150px;">
 			<h4>장바구니</h4>
			...
			<table class= "table table-bordered" style="width: 80%">
				...
				<c:forEach items="${cartList}" var="c">
					<tr>
						<td>${c.cartNo}</td>
						<td>${c.goodsNo}</td>
						<td><img src="${pageContext.request.contextPath}/upload/${c.goodsFileName}.${c.goodsFileExt}" width="100" >
						${c.goodsTitle}</td>
	...
	<form method="post" id="formPayment" action="${pageContext.request.contextPath}/customer/payment">
		...
		<button id="btnPayment" type="button" class="btn btn-primary">결제</button>
	</form>
	</div>
	<hr>
    <!-- Footer-->
