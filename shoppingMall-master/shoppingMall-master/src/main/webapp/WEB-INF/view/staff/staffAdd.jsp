...
<body >
 <header class="bg-dark text-white py-3">
    ...
    <a href="${pageContext.request.contextPath}/logout" class="btn btn-outline-light btn-sm btn-custom">로그아웃</a>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <form id="addCategory" method="post" action="${pageContext.request.contextPath }/staff/staffAdd">
		<table>
    <tr>
        <td>staffId</td>
    </tr>
    ...
    <tr>
        <td><input type="text" name="staffPw"></td>
    </tr>
</table>
		<button type="submit" class="btn btn-outline-primary mt-3">add staff</button>
		</form>
            </div>
        </div>
    </div>
