   ...
   <div class="container-fluid mt-5">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form action="${pageContext.request.contextPath}/staff/goodsCategoryAdd" method="post" class="d-flex gap-3">
                <div class="d-flex align-items-center">
                    <label for="goodsNo" class="me-2">Goods No:</label>
                    <input type="number" id="goodsNo" name="goodsNo" required class="form-control">
                </div>
                <div class="d-flex align-items-center">
                    <label for="categoryNo" class="me-2">Category No:</label>
                    <input type="number" id="categoryNo" name="categoryNo" required class="form-control">
                </div>
