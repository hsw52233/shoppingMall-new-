    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="d-flex flex-column align-items-start">
                ...
                <form action="${pageContext.request.contextPath}/staff/goodsModify" method="post" class="w-100">
                    <input type="hidden" name="goodsNo" value="${goods.goodsNo}">
                    <div class="mb-3">
                        <label for="goodsTitle" class="form-label">Goods Title:</label>
                        <input type="text" id="goodsTitle" name="goodsTitle" value="${goods.goodsTitle}" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="goodsMemo" class="form-label">Goods Memo:</label>
                        <input type="text" id="goodsMemo" name="goodsMemo" value="${goods.goodsMemo}" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="goodsPrice" class="form-label">Goods Price:</label>
                        <input type="number" id="goodsPrice" name="goodsPrice" value="${goods.goodsPrice}" class="form-control">
                    </div>
